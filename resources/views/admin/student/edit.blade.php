                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <select name="id_name_dept" class="custom-select2" style="width: 100%" required>
                                <option value="" selected disabled>{{ $student->student_id. " - " .$student->name. " - " .$student->dept}}</option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="custom-select2 form-control" id="building" style="width: 100%; height: 38px;"
                                ...
                                <option selected value='{{ $student->building }}'>{{ $building->name }}</option>
                                {{-- // todo: get student building form database --}}
                        ...
                        <div class="form-group col-md-6">
                            <label for="">Status:</label>                           
                                <select class="custom-select2 form-control" value="{{ $student->status }}"
                                name="status" placeholder='Select a Value' required>
