    ...
    <div class="menu-block customscroll">
      <div class="sidebar-menu">
        <ul id="accordion-menu">
          <li class="dropdown">
            <a href="{{ route('student.dashboard') }}" class="dropdown-toggle no-arrow {{ Request::is('student/dashboard') ? 'active' : '' }}">
          ...
          <li class="dropdown">
            ...
            <ul class="submenu">
              <li><a href="{{ route('student.meal.chart') }}" class="dropdown-toggle no-arrow {{ Request::is('student/meal/chart') ? 'active' : '' }}">
                  <span class="mtext">Chart</span>
                </a>
              </li>
              <li>
                <a href="{{ route('student.meal.book') }}"
                  class="dropdown-toggle no-arrow {{ Request::is('student/meal/select') ? 'active' : '' }} {{ Request::is('student/meal/generate') ? 'active' : '' }}">
